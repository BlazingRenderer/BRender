...
/*__inline br_fixed_ls BrFixedSin(br_angle a)
{
	return BR_SIN(a);
	//return BrFloatToFixed((float)sin(BrAngleToRadian(a)));
}*/

br_fixed_ls BR_ASM_CALL BrFixedCos(br_angle a);
/*__inline br_fixed_ls BrFixedCos(br_angle a)
{
	return BR_COS(a);
	//return BrFloatToFixed((float)cos(BrAngleToRadian(a)));
}*/
