...
static char *med3(char *a, char *b, char *c, int (*cmp)(const void *a, const void *b))
{
	return cmp(a, b) < 0 ?
...
void BR_RESIDENT_ENTRY BrQsort(void *a, unsigned int n, unsigned int es, br_qsort_cbfn *cmp)
{
