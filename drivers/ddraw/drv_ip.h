...
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, line)(br_device_pixelmap *self, br_point *s, br_point *e,
                                                       br_uint_32 colour);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleFill)(br_device_pixelmap *self, br_rectangle *r,
                                                                br_uint_32 colour);
