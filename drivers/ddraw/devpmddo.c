...
void BrDD_SetPixelFormat(LPDDSURFACEDESC ddsd, int type)
{
    ...
    switch(type) {
        ...
        default:
            BR_ERROR0("Unsupported BRender pixel format. Sorry.");
    }
}
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, allocateSub)(br_device_pixelmap  *self,
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, copy)(br_device_pixelmap *self, br_device_pixelmap *src)
{
    RECT srect, drect;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleCopy)(br_device_pixelmap *self, br_point *p,
                                                                br_device_pixelmap *src, br_rectangle *r)
{
     ...
     * Set the source and destination RECTs
     */
    if(!SetRect(&srect, src->pm_base_x + rr.x, src->pm_base_y + rr.y, src->pm_base_x + rr.x + rr.w,
                src->pm_base_y + rr.y + rr.h) ||
       !SetRect(&drect, self->pm_base_x + rr.x, self->pm_base_y + rr.y, self->pm_base_x + pp.x + rr.w,
                self->pm_base_y + pp.y + rr.h))
        return BRE_FAIL;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleCopyTo)(br_device_pixelmap *self, br_point *p,
                                                                  br_device_pixelmap *src, br_rectangle *r)
{
    br_error result;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleCopyFrom)(br_device_pixelmap *self, br_point *p,
                                                                    br_device_pixelmap *src, br_rectangle *r)
{
    br_error result;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleStretchCopy)(br_device_pixelmap *self, br_rectangle *d,
                                                                       br_device_pixelmap *src, br_rectangle *s)
{
     ...
     * Set the source and destination RECTs
     */
    if(!SetRect(&srect, src->pm_base_x + ss.x, src->pm_base_y + ss.y, src->pm_base_x + ss.x + ss.w,
                src->pm_base_y + ss.y + ss.h) ||
       !SetRect(&drect, self->pm_base_x + dd.x, self->pm_base_y + dd.y, self->pm_base_x + dd.x + dd.w,
                self->pm_base_y + dd.y + dd.h))
        return BRE_FAIL;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleStretchCopyTo)(br_device_pixelmap *self, br_rectangle *d,
                                                                         br_device_pixelmap *src, br_rectangle *s)
{
    br_error result;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleStretchCopyFrom)(br_device_pixelmap *self, br_rectangle *d,
                                                                           br_device_pixelmap *src, br_rectangle *s)
{
    br_error result;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, pixelSet)(br_device_pixelmap *self, br_point *p, br_uint_32 colour)
{
    br_error result;
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, line)(br_device_pixelmap *self, br_point *s, br_point *e, br_uint_32 colour)
{
    br_error result;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, copyBits)(br_device_pixelmap *self, br_point *point, br_uint_8 *src,
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, fill)(br_device_pixelmap *self, br_uint_32 colour)
{
    HRESULT ddrval;
    RECT    rect;
    DDBLTFX bltfx;

    if(self->sub_pixelmap && !SetRect(&rect, self->pm_base_x, self->pm_base_y, self->pm_base_x + self->pm_width,
                                      self->pm_base_y + self->pm_height))
        return BRE_FAIL;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, rectangleFill)(br_device_pixelmap *self, br_rectangle *r, br_uint_32 colour)
{
    br_rectangle rr;
    RECT         rect;
    DDBLTFX      bltfx;
     ...
     */
    if(!SetRect(&rect, self->pm_base_x + rr.x, self->pm_base_y + rr.y, self->pm_base_x + rr.x + rr.w,
                self->pm_base_y + rr.y + rr.h))
        return BRE_FAIL;
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, pixelQuery)(br_device_pixelmap *self, br_uint_32 *pcolour, br_point *p)
{
    br_error result;
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, fillDirty)(br_device_pixelmap *self, br_uint_32 colour,
                                                            br_rectangle *dirty, br_int_32 num_rects)
{
    ...
    for(i = 0; i < num_rects; i++, dirty++) {
         ...
         * Set destination RECT
         */
        SetRect(&rect, self->pm_base_x + dirty->x, self->pm_base_y + dirty->y, self->pm_base_x + dirty->x + dirty->w,
                self->pm_base_y + dirty->y + dirty->h);
 ...
 */
br_error BR_CMETHOD_DECL(br_device_pixelmap_ddo, match)(br_device_pixelmap *self, br_device_pixelmap **newpm,
                                                        br_token_value *tv)
{
    br_int_32               count;
    br_error                result;
