 ...
 */
static br_error BR_CMETHOD_DECL(br_device_clut_dd, entrySet)(br_device_clut *self, br_int_32 index, br_colour entry)
{
    int          half_nstatic;
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_clut_dd, entrySetMany)(br_device_clut *self, br_int_32 index, br_int_32 count,
                                                                 br_colour *entries)
{
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_clut_dd, entryQuery)(br_device_clut *self, br_colour *entry, br_int_32 index)
{
    return BRE_FAIL;
}
 ...
 **/
static br_error BR_CMETHOD_DECL(br_device_clut_dd, entryQueryMany)(br_device_clut *self, br_colour *entries,
