...
#endif
    BRPM_TO_GL(BR_PMT_RGBX_888,      GL_RGBA, GL_RGBA,        GL_UNSIGNED_BYTE,              3, BR_FALSE, BR_FALSE, BLUE, GREEN, RED,   ONE), // NB: LE: FIXME
    BRPM_TO_GL(BR_PMT_RGBA_8888,     GL_RGBA, GL_RGBA,        GL_UNSIGNED_BYTE,              4, BR_TRUE,  BR_FALSE, BLUE, GREEN, RED, ALPHA),  // NB: LE: FIXME
    BRPM_TO_GL(BR_PMT_RGBA_8888_ARR, GL_RGBA, GL_RGBA,        GL_UNSIGNED_BYTE,              4, BR_TRUE,  BR_FALSE, RED, GREEN, BLUE, ALPHA),
    BRPM_TO_GL(BR_PMT_R8G8B8A8,      GL_RGBA, GL_RGBA,        GL_UNSIGNED_BYTE,              4, BR_TRUE,  BR_FALSE, ALPHA, BLUE, GREEN, RED), // NB: LE: FIXME
...
#if defined(GL_DEPTH_COMPONENT32) /* Not in ES. */
