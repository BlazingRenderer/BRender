...
br_device_pixelmap *DevicePixelmapDOSAllocate(br_device *dev, br_output_facility *outfcty, SDL_Window *window, SDL_Surface *surface, br_boolean owned)
{
...
static void BR_CMETHOD_DECL(br_device_pixelmap_dos, free)(br_object *_self)
{
...
static const char *BR_CMETHOD_DECL(br_device_pixelmap_dos, identifier)(br_object *self)
{
    return ((br_device_pixelmap *)self)->pm_identifier;
}

static br_device *BR_CMETHOD_DECL(br_device_pixelmap_dos, device)(br_object *self)
{
    return ((br_device_pixelmap *)self)->device;
}

static br_token BR_CMETHOD_DECL(br_device_pixelmap_dos, type)(br_object *self)
{
    (void)self;
    return BRT_DEVICE_PIXELMAP;
}

static br_boolean BR_CMETHOD_DECL(br_device_pixelmap_dos, isType)(br_object *self, br_token t)
{
    (void)self;
    return (t == BRT_DEVICE_PIXELMAP) || (t == BRT_OBJECT);
}

static br_size_t BR_CMETHOD_DECL(br_device_pixelmap_dos, space)(br_object *self)
{
    (void)self;
    return sizeof(br_device_pixelmap);
}

static struct br_tv_template *BR_CMETHOD_DECL(br_device_pixelmap_dos, queryTemplate)(br_object *_self)
{
    br_device_pixelmap *self = (br_device_pixelmap *)_self;
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, resize)(br_device_pixelmap *self, br_int_32 width, br_int_32 height)
{
    SDL_Surface *surface;
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, validSource)(br_device_pixelmap *self, br_boolean *bp, br_object *h)
{
    /*
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, allocateSub)(br_device_pixelmap *self, br_device_pixelmap **newpm, br_rectangle *rect)
{
    br_rectangle        out;
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, copy)(br_device_pixelmap *self, br_device_pixelmap *src)
{
    SDL_Rect     drect;
    br_rectangle r = {
        .x = -self->pm_origin_x,
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, rectangleCopyTo)(br_device_pixelmap *self, br_point *p, br_device_pixelmap *src,
                                                                          br_rectangle *r)
{
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, rectangleCopyFrom)(br_device_pixelmap *self, br_point *p, br_device_pixelmap *dest,
                                                                            br_rectangle *r)
{
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, rectangleStretchCopyTo)(br_device_pixelmap *self, br_rectangle *d,
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, rectangleStretchCopyFrom)(br_device_pixelmap *self, br_rectangle *s,
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, pixelSet)(br_device_pixelmap *self, br_point *p, br_uint_32 colour)
{
    SDL_Point point;
    SDL_Color col;
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, line)(br_device_pixelmap *self, br_point *s, br_point *e, br_uint_32 colour)
{
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, rectangleFill)(br_device_pixelmap *self, br_rectangle *r, br_uint_32 colour)
{
    SDL_Rect  rect;
    SDL_FRect frect;
    SDL_Color col;
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, pixelQuery)(br_device_pixelmap *self, br_uint_32 *pcolour, br_point *p)
{
    br_error  err;
    SDL_Point ap;
    br_colour col;
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, pixelAddressQuery)(br_device_pixelmap *self, void **pptr, br_uint_32 *pqual, br_point *p)
{
    SDL_Point ap;
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, directLock)(br_device_pixelmap *self, br_boolean block)
{
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, directUnlock)(br_device_pixelmap *self)
{
    if(SDL_MUSTLOCK(self->surface) == 0)
        return BRE_OK;
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, doubleBuffer)(br_device_pixelmap *self, br_device_pixelmap *src)
{
    br_error err;
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, match)(br_device_pixelmap *self, br_device_pixelmap **newpm, br_token_value *tv)
{
    br_int_32           count;
    br_device_pixelmap *pm;
    SDL_Surface        *surface;
 ...
 */
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, handleWindowEvent)(br_device_pixelmap *self, void *arg)
{
...
static br_error BR_CMETHOD_DECL(br_device_pixelmap_dos, flush)(struct br_device_pixelmap *self)
{
    SDL_FlushRenderer(self->renderer);
    return BRE_OK;
}
...
static const struct br_device_pixelmap_dispatch devicePixelmapDispatch = {
    ...
    .__reserved2 = NULL,
    .__reserved3 = NULL,
    ._free       = BR_CMETHOD_REF(br_device_pixelmap_dos, free),
    ._identifier = BR_CMETHOD_REF(br_device_pixelmap_dos, identifier),
    ._type       = BR_CMETHOD_REF(br_device_pixelmap_dos, type),
    ._isType     = BR_CMETHOD_REF(br_device_pixelmap_dos, isType),
    ._device     = BR_CMETHOD_REF(br_device_pixelmap_dos, device),
    ._space      = BR_CMETHOD_REF(br_device_pixelmap_dos, space),

    ._templateQuery = BR_CMETHOD_REF(br_device_pixelmap_dos, queryTemplate),
    ...
    ._validSource = BR_CMETHOD_REF(br_device_pixelmap_dos, validSource),
    ._resize      = BR_CMETHOD_REF(br_device_pixelmap_dos, resize),
    ._match       = BR_CMETHOD_REF(br_device_pixelmap_dos, match),
    ._allocateSub = BR_CMETHOD_REF(br_device_pixelmap_dos, allocateSub),

    ._copy         = BR_CMETHOD_REF(br_device_pixelmap_dos, copy),
    ...
    ._doubleBuffer = BR_CMETHOD_REF(br_device_pixelmap_dos, doubleBuffer),
    ...
    ._rectangleCopy            = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleCopyTo),
    ._rectangleCopyTo          = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleCopyTo),
    ._rectangleCopyFrom        = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleCopyFrom),
    ._rectangleStretchCopy     = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleStretchCopyTo),
    ._rectangleStretchCopyTo   = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleStretchCopyTo),
    ._rectangleStretchCopyFrom = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleStretchCopyFrom),
    ._rectangleFill            = BR_CMETHOD_REF(br_device_pixelmap_dos, rectangleFill),
    ._pixelSet                 = BR_CMETHOD_REF(br_device_pixelmap_dos, pixelSet),
    ._line                     = BR_CMETHOD_REF(br_device_pixelmap_dos, line),
    ...
    ._pixelQuery        = BR_CMETHOD_REF(br_device_pixelmap_dos, pixelQuery),
    ._pixelAddressQuery = BR_CMETHOD_REF(br_device_pixelmap_dos, pixelAddressQuery),
    ...
    ._flush        = BR_CMETHOD_REF(br_device_pixelmap_dos, flush),
    ._synchronise  = BR_CMETHOD_REF(br_device_pixelmap_gen, synchronise),
    ._directLock   = BR_CMETHOD_REF(br_device_pixelmap_dos, directLock),
    ._directUnlock = BR_CMETHOD_REF(br_device_pixelmap_dos, directUnlock),
    ...
    ._handleWindowEvent = BR_CMETHOD_REF(br_device_pixelmap_dos, handleWindowEvent),
};
