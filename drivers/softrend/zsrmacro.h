 ...
 */
#define SORT_VALUE_TRIANGLE(type, v0, v1, v2)                          \
    do {                                                               \
        zprim = VIEW_Z(v0);                                            \
        switch(type) {                                                 \
            case BR_SORT_MIN:                                          \
 ...
 */
#define INSERT_PRIMITIVE_FIRST_BUCKET(ot, prim, depth) \
    do {                                               \
 ...
 */
#define INSERT_PRIMITIVE_HEAD(ot, prim, depth)                    \
    do {                                                          \
        int bucket;                                               \
 ...
 */
#define INSERT_PRIMITIVE(ot, prim, depth)                   \
    do {                                                    \
