...
averageVerticesOnScreen proc renderer:ptr br_renderer, m0:ptr brp_vertex, m1:ptr brp_vertex, m2:ptr brp_vertex, v0:ptr brp_vertex, v1:ptr brp_vertex, v2:ptr brp_vertex
