 ...
 */
static void BR_CMETHOD_DECL(br_output_facility_vk, free)(br_object *_self)
{
...
static const char *BR_CMETHOD_DECL(br_output_facility_vk, identifier)(br_object *self)
{
    return ((br_output_facility *)self)->identifier;
}

static br_token BR_CMETHOD_DECL(br_output_facility_vk, type)(br_object *self)
{
    (void)self;
    return BRT_OUTPUT_FACILITY;
}

static br_boolean BR_CMETHOD_DECL(br_output_facility_vk, isType)(br_object *self, br_token t)
{
    (void)self;
    return (t == BRT_OUTPUT_FACILITY) || (t == BRT_OBJECT_CONTAINER) || (t == BRT_OBJECT);
}

static br_device *BR_CMETHOD_DECL(br_output_facility_vk, device)(br_object *self)
{
    return ((br_output_facility *)self)->device;
}

static br_size_t BR_CMETHOD_DECL(br_output_facility_vk, space)(br_object *self)
{
    (void)self;
    return sizeof(br_output_facility);
}

static br_tv_template *BR_CMETHOD_DECL(br_output_facility_vk, queryTemplate)(br_object *_self)
{
    br_output_facility *self = (br_output_facility *)_self;
...
static br_error BR_CMETHOD_DECL(br_output_facility_vk, validSource)(br_output_facility *self, br_boolean *bp, br_object *h)
{
    (void)self;
    (void)bp;
    (void)h;
 ...
 */
static br_error BR_CMETHOD_DECL(br_output_facility_vk, pixelmapNew)(br_output_facility *self, br_device_pixelmap **ppmap, br_token_value *tv)
{
 ...
 */
static br_error BR_CMETHOD_DECL(br_output_facility_vk, clutNew)(br_output_facility *self, br_device_clut **pclut, br_token_value *tv)
{
    (void)self;
    (void)pclut;
    (void)tv;
...
static br_error BR_CMETHOD_DECL(br_output_facility_vk, queryCapability)(br_output_facility *self, br_token_value *buffer_in,
...
static void *BR_CMETHOD_DECL(br_output_facility_vk, listQuery)(br_object_container *self)
{
...
static const struct br_output_facility_dispatch outputFacilityDispatch = {
    ...
    .__reserved2 = NULL,
    .__reserved3 = NULL,
    ._free       = BR_CMETHOD_REF(br_output_facility_vk, free),
    ._identifier = BR_CMETHOD_REF(br_output_facility_vk, identifier),
    ._type       = BR_CMETHOD_REF(br_output_facility_vk, type),
    ._isType     = BR_CMETHOD_REF(br_output_facility_vk, isType),
    ._device     = BR_CMETHOD_REF(br_output_facility_vk, device),
    ._space      = BR_CMETHOD_REF(br_output_facility_vk, space),

    ._templateQuery = BR_CMETHOD_REF(br_output_facility_vk, queryTemplate),
    ...
    ._listQuery            = BR_CMETHOD_REF(br_output_facility_vk, listQuery),
    ...
    ._validSource     = BR_CMETHOD_REF(br_output_facility_vk, validSource),
    ._pixelmapNew     = BR_CMETHOD_REF(br_output_facility_vk, pixelmapNew),
    ._clutNew         = BR_CMETHOD_REF(br_output_facility_vk, clutNew),
    ._queryCapability = BR_CMETHOD_REF(br_output_facility_vk, queryCapability),
};
