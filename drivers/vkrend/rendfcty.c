...
br_renderer_facility *RendererFacilityVkAllocate(br_device *device)
{
...
static void BR_CMETHOD_DECL(br_renderer_facility_vk, free)(br_object *_self)
{
...
static const char *BR_CMETHOD_DECL(br_renderer_facility_vk, identifier)(br_object *self)
{
    return ((br_renderer_facility *)self)->identifier;
}

static br_token BR_CMETHOD_DECL(br_renderer_facility_vk, type)(br_object *self)
{
    (void)self;
    return BRT_RENDERER_FACILITY;
}

static br_boolean BR_CMETHOD_DECL(br_renderer_facility_vk, isType)(br_object *self, br_token t)
{
    (void)self;
    return (t == BRT_RENDERER_FACILITY) || (t == BRT_OBJECT_CONTAINER) || (t == BRT_OBJECT);
}

static br_device *BR_CMETHOD_DECL(br_renderer_facility_vk, device)(br_object *self)
{
    return ((br_renderer_facility *)self)->device;
}

static br_size_t BR_CMETHOD_DECL(br_renderer_facility_vk, space)(br_object *self)
{
    (void)self;
    return sizeof(br_renderer_facility);
}

static br_tv_template *BR_CMETHOD_DECL(br_renderer_facility_vk, templateQuery)(br_object *_self)
{
    br_renderer_facility *self = (br_renderer_facility *)_self;
...
static br_error BR_CMETHOD_DECL(br_renderer_facility_vk, validDestination)(br_renderer_facility *self, br_boolean *bp, br_object *h)
{
    (void)self;
    (void)bp;
    (void)h;
 ...
 */
static br_error BR_CMETHOD_DECL(br_renderer_facility_vk, rendererNew)(br_renderer_facility *self, struct br_renderer **prenderer, br_token_value *tv)
{
...
static void *BR_CMETHOD_DECL(br_renderer_facility_vk, listQuery)(br_object_container *self)
{
...
static const struct br_renderer_facility_dispatch rendererFacilityDispatch = {
    ...
    .__reserved2 = NULL,
    .__reserved3 = NULL,
    ._free       = BR_CMETHOD_REF(br_renderer_facility_vk, free),
    ._identifier = BR_CMETHOD_REF(br_renderer_facility_vk, identifier),
    ._type       = BR_CMETHOD_REF(br_renderer_facility_vk, type),
    ._isType     = BR_CMETHOD_REF(br_renderer_facility_vk, isType),
    ._device     = BR_CMETHOD_REF(br_renderer_facility_vk, device),
    ._space      = BR_CMETHOD_REF(br_renderer_facility_vk, space),

    ._templateQuery = BR_CMETHOD_REF(br_renderer_facility_vk, templateQuery),
    ...
    ._listQuery            = BR_CMETHOD_REF(br_renderer_facility_vk, listQuery),
    ...
    ._validDestination = BR_CMETHOD_REF(br_renderer_facility_vk, validDestination),

    ._rendererNew = BR_CMETHOD_REF(br_renderer_facility_vk, rendererNew),
};
