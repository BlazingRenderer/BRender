...
void BR_ASM_CALL VESAWindowCopyFromLines(br_uint_8 *mem, br_uint_32 mem_stride);
void BR_ASM_CALL VESAWindowCopyFromLinear(br_uint_8 *mem, br_uint_32 mem_stride);
