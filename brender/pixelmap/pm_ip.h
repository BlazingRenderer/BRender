...
br_error BR_CMETHOD_DECL(br_device_pixelmap_mem, validSource)
	(struct br_device_pixelmap *self, br_boolean *bp, br_object *h);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_fail, allocateSub)(struct br_device_pixelmap *self,
                                                               struct br_device_pixelmap **newpm,
                                                               br_rectangle *rect);
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_fail, line)(struct br_device_pixelmap *self, br_point *s, br_point *e,
                                                        br_uint_32 colour);
br_error BR_CMETHOD_DECL(br_device_pixelmap_fail, copyBits)(struct br_device_pixelmap *_self, br_point *point, br_uint_8 *src,
...
br_error BR_CMETHOD_DECL(br_device_pixelmap_fail, synchronise)(struct br_device_pixelmap *self,
