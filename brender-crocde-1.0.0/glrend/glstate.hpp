...
typedef struct _GLSTATE_PRIMITIVE
{
	...
	*/
	br_buffer_stored_gl *colour_map;
	br_buffer_stored_gl *index_shade;
	br_buffer_stored_gl *index_blend;
	br_buffer_stored_gl *index_fog;
	br_buffer_stored_gl *screendoor;
	br_buffer_stored_gl *lighting;
	br_buffer_stored_gl *bump;
...
{
	br_device_pixelmap_gl *colour;
	br_device_pixelmap_gl *depth;
...
GLSTATE_API bool GLSTATE_Push(HGLSTATE hState, uint32_t mask);
GLSTATE_API bool GLSTATE_Pop(HGLSTATE hState, uint32_t mask);
