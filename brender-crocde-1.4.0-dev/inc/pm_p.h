...
br_uint_32 BR_PUBLIC_ENTRY BrPixelmapSave(const char *filename,
	br_pixelmap *pixelmap);
br_uint_32 BR_PUBLIC_ENTRY BrPixelmapLoadMany(const char *filename,
	br_pixelmap **pixelmaps,br_uint_16 num);
br_uint_32 BR_PUBLIC_ENTRY BrPixelmapSaveMany(const char *filename,
	br_pixelmap **pixelmaps,br_uint_16 num);
