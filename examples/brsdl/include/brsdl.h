...
void BrSDLUtilCleanupScreen(br_pixelmap **screen, br_pixelmap **colour_buffer, br_pixelmap **depth_buffer);

/*
 * Attempt to resize the screen, falling back to (re)creation if we can't.
 * Will re-initialise the renderer.
 */
br_boolean BrSDLUtilResizeScreen(const char *driver, SDL_Window *window, br_pixelmap **screen, br_pixelmap **colour_buffer,
                                 br_pixelmap **depth_buffer, void *primitive_heap, br_size_t primitive_heap_size,
...
br_boolean BrSDLUtilOnResize(SDL_Window *window, const char *driver, br_pixelmap **screen, br_pixelmap **colour_buffer,
                             br_pixelmap **depth_buffer, void *primitive_heap, br_size_t primitive_heap_size,
                             br_camera *camera);
